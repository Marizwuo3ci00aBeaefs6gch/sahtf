...
```markdown
# API Endpoints for AI Service (Update 13)
...
- **Response**:
  ```json
  {
    ...
    "job_id": "retrain-job-13",
    "estimated_completion": "2025-06-13T18:00:00"
  }
  ```
```

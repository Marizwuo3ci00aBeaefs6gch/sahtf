...
```markdown
# API Endpoints for AI Service (Update 14)
...
- **Response**:
  ```json
  {
    ...
    "job_id": "retrain-job-14",
    "estimated_completion": "2025-06-14T18:00:00"
  }
  ```
```
